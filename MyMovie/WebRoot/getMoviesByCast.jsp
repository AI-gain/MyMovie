...
<%@ page import="oracle.demo.oow.bd.dao.hbase.CastDao" %>
<%@ page import="oracle.demo.oow.bd.dao.CrewDAO" %>
<%@ page import="oracle.demo.oow.bd.dao.hbase.CrewDao" %>
...
if (castId!=null){
  ...
  if (type.equalsIgnoreCase("actor")){
    ...
    CastDao castDao = new CastDao();
    movieList = castDao.getMoviesByCast(castId); 
  }else {
    //CrewDAO crewDao = new CrewDAO();
    CrewDao crewDao = new CrewDao();
    movieList = crewDao.getMoviesByCrew(castId);
  }
