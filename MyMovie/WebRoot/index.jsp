...
<html>
  ...
  <div id="main">
    ...
    <%
      ...
      System.out.println("******** Continue Watching key Start ********");
      //movieTOList1 = aDAO.getCustomerCurrentWatchList(userId);
      movieTOList1 = activityDao.getCustomerCurrentWatchList(userId);
      System.out.println("******** Continue Watching key End   ********");
      System.out.println("");
    ...
    <%
      ///////////////////////RECENTLY BROWSED///////////////////////
      System.out.println("******** Recently Browsed key Start ********");
      //movieTOList1 = aDAO.getCustomerBrowseList(userId);
      movieTOList1 = activityDao.getCustomerBrowseList(userId);
      System.out.println("******** Recently Browsed key End   ********");
      System.out.println("");
    ...
    genreList = customerDao.getMoviesForCustomer(userId, 30, 6);
            ...
            <div class="jspPane" style="padding: 0px; width: 782px; left: 0px; ">
                ...
                <ul id="mycarousel<%= categoryId %>" class="jcarousel-skin-name">
                 <%
                    ...
                    movieTOListEXT = customerDao.getMoviesForCustomerByGenre(userId, categoryId);
    ...
    <%--  <%
      ...
      System.out.println("******** What Others Wathching key Start ********");
      movieTOList1 = aDAO.getCommonPlayList();
      System.out.println("******** What Others Wathching key End   ********");
      System.out.println("");
      if (movieTOList1.size()>0){
    %>
    <div class="wbox dark">
    ...
    <% }%> --%>
      ...
      <%
      ///////////////////////PRIVIOUSLY WATCHED//////////////////////
      System.out.println("******** Priviously Watched key Start ********");
      //movieTOList1 = aDAO.getCustomerHistoricWatchList(userId);
      movieTOList1 = activityDao.getCustomerHistoricWatchList(userId);
      System.out.println("******** Priviously Watched key End   ********");
      System.out.println("");
      if (movieTOList1.size()>0){
    %>
    <div class="wbox dark">
