...
public interface Constant {
    ...
    public static final String WIKI_MOVIE_INFO_FILE_NAME =
        METADATA_DIR + File.separator + File.separator + "movie-info.out";

    public static final String WIKI_MOVIE_CAST_FILE_NAME =
        METADATA_DIR + File.separator + File.separator + "movie-cast.out";

    public static final String WIKI_MOVIE_CREW_FILE_NAME =
        METADATA_DIR + File.separator + File.separator + "movie-crew.out";
