package oracle.demo.oow.bd.constant.hbase;
...
public class ConstantsHBase {
		...
		public static String MYSQL_PASSWORD="153532";
		...
		public static final String FAMILY_CUSTOMER_ID = "id";
		public static final String FAMILY_CUSTOMER_CUSTOMER = "info";
		public static final String FAMILY_CUSTOMER_GENRE = "genre";
		...
		//CUSTOMER表
		public static final String QUALIFIER_CUSTOMER_ID = "id";
		public static final String QUALIFIER_CUSTOMER_NAME = "name";
		public static final String QUALIFIER_CUSTOMER_EMAIL = "email";
		public static final String QUALIFIER_CUSTOMER_USERNAME = "username";
		public static final String QUALIFIER_CUSTOMER_CUSTOMERNAME = "CUSTOMERname";
		public static final String QUALIFIER_CUSTOMER_PASSWORD = "password";
		public static final String QUALIFIER_CUSTOMER_GENRE_ID = "genre_id";
		public static final String QUALIFIER_CUSTOMER_GENRE_NAME = "genre_name";
		public static final String QUALIFIER_CUSTOMER_SCORE = "score";
		//genre表
		...
		//activity表
		public static final String QUALIFIER_ACTIVITY_CUSTOMER_ID = "CUSTOMER_id";
